...
The present benchmark was conducted on 2025-06-17 on a Macbook Pro M4
(12-core CPU, 16-core GPU, 24GB RAM). Results *will* vary depending on
the hardware. These benchmarks aim to provide a general idea of the
...
generally faster.](figure/benchmark_m4_a-1.png)
...
slower.](figure/benchmark_m4_b-1.png)
...
matrices 1000x1000 and larger.](figure/benchmark_m4_c-1.png)
...
Results shows that {fio} is considerably faster for smaller matrices,
but slightly slower for larger ones.
...
![\label{fig:benchmark_d} {fio} is faster for smaller
matrices.](figure/benchmark_m4_d-1.png)

{fio} is faster for smaller matrices.
