...
You can install the released version of `{fio}` from [R-universe](https://r-universe.dev/) with:

```r
install.packages("fio", repos = c("https://albersonmiranda.r-universe.dev", "https://cloud.r-project.org"))
```

For macOS and Linux, or if you wish to compile the latest development version from source, you'll need [Rust](https://www.rust-lang.org/) installed on your system.
...
You'll also find previous releases of `fio` in the [Releases section](https://github.com/albersonmiranda/fio/releases) on GitHub, and precompiled binaries for Windows, macOS, and Linux at [R-universe](https://albersonmiranda.r-universe.dev/fio).
