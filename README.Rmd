...
If you prefer compiling from source, [Rust](https://rust-lang.org/) is required to be installed on your system. You can install Rust from your OS package manager or, preferably, from [official installer](https://rust-lang.org/tools/install/).
