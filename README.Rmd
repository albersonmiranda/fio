...
You can install the released version of `{fio}` from [R-universe](https://albersonmiranda.r-universe.dev/fio) with:

```r
install.packages("fio", repos = c("https://albersonmiranda.r-universe.dev", "https://cloud.r-project.org"))
```

For Linux, or if you wish to compile the latest development version from source, you'll need [Rust](https://www.rust-lang.org/) installed on your system.
...
You'll also find previous releases of `fio` and precompiled binaries for Windows, macOS, and Linux in the [Releases section](https://github.com/albersonmiranda/fio/releases) on GitHub or at [R-universe](https://albersonmiranda.r-universe.dev/fio).
