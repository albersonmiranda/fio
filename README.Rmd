...
For macOS and Linux, or if you wish to compile the latest development version from source, you will need to have [Rust](https://www.rust-lang.org/) installed on your system.
