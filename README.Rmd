...
You can install the latest version from the [main branch](https://github.com/albersonmiranda/fio/tree/main), using the precompiled binaries available on [R-universe](https://albersonmiranda.r-universe.dev/fio):
...
For the cutting-edge development branches from Github (other than the main branch), you'll need to compile it from source. This requires [Rust](https://www.rust-lang.org/) to be installed on your system. You can install Rust using the following commands:
