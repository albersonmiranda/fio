...
1. Optional fields
  1. Final demand fields
    ...
    - `final_demand_matrix`: A matrix for final demand. It aggregates all the total final demand vectors. After you add or remove a vector, update this matrix with `$update_final_demand_matrix()` method.
  1. Added value fields
    ...
    - `added_value_matrix`: A matrix for added value. It aggregates all the total added value vectors. After you add or remove a vector, update this matrix with `$udpate_added_value_matrix()` method.
  1. Other optional fields
...
1. Results slots
  ...
  - `hypothetical_extraction`: A dataframe with absolute and relative backward, forward and total differences in total output after hypothetical extraction of each sector.
