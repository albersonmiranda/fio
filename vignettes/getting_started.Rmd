...
- `influence_field`: a matrix with the field of influence.
...
Other methods available are `compute_leontief_inverse()`, `compute_ghosh_inverse()`, `compute_multiplier_output()`, `compute_influence_field()`, and `compute_key_sectors()`. Their names are clear and self explanatory. You can also chain these methods to do all at once:
