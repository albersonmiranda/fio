...
<img src="figure/benchmark_i7_a-1.png" alt="\label{fig:benchmark_a} For larger matrices (≥500x500), {fio} is generally faster."  />
...
Results shows that for larger matrices, `{fio}` is slightly slower than the alternatives.
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i7_b-1.png" alt="\label{fig:benchmark_b} For larger matrices, {fio} is slightly slower than the alternatives."  />
<p class="caption">\label{fig:benchmark_b} For larger matrices, `{fio}` is slightly slower than the alternatives.</p>
</div>
...
Results shows that {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 1000x1000 and larger.
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i7_c-1.png" alt="\label{fig:benchmark_c} {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 1000x1000 and larger."  />
<p class="caption">\label{fig:benchmark_c} {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 1000x1000 and larger.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i7_d-1.png" alt="\label{fig:benchmark_d} {fio} is faster than the Base R implementation."  />
<p class="caption">\label{fig:benchmark_d} {fio} is faster than the Base R implementation.</p>
</div>
