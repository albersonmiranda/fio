...
Table: Net Spillover Effects Matrix (sample)
...
Table: Key Sectors in WIOD 2014
...
<img src="figure/self_reliance_plot-1.png" alt="plot of chunk self_reliance_plot"  />
<p class="caption">plot of chunk self_reliance_plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/spillover_out_plot-1.png" alt="plot of chunk spillover_out_plot"  />
<p class="caption">plot of chunk spillover_out_plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/spillover_in_plot-1.png" alt="plot of chunk spillover_in_plot"  />
<p class="caption">plot of chunk spillover_in_plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/spillover_balance_plot-1.png" alt="plot of chunk spillover_balance_plot"  />
<p class="caption">plot of chunk spillover_balance_plot</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/spillover_share_plot-1.png" alt="plot of chunk spillover_share_plot"  />
<p class="caption">plot of chunk spillover_share_plot</p>
</div>
...
Table: Trade flows from USA to CHN (first 10 buying sectors, first 5 supplying sectors)
...
Table: Trade flows from CHN to USA (first 10 buying sectors, first 5 supplying sectors)
...
Table: USA Domestic Intermediate Transactions (first 8x8 sectors)
...
Table: USA Total Production (first 12 sectors)
...
Table: USA Domestic Output Multipliers (first 12 sectors)
