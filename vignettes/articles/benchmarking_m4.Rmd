...
<img src="figure/benchmark_m4_a-1.png" alt="\\label{fig:benchmark_a} For larger matrices (≥500x500), {fio} is generally faster than alternatives."  />
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_m4_b-1.png" alt="\\label{fig:benchmark_b} Faster on the R side; reported memory figures are R-side only (see note)."  />
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_m4_c-1.png" alt="\\label{fig:benchmark_c} Faster on the R side; reported memory figures are R-side only (see note)."  />
...
Results shows that {fio} is considerably faster for smaller matrices, but slightly slower for larger ones. The `bench` summaries report much smaller R-side allocations for `fio` across the tested dimensions. For the 200x200 matrix the `bench` R-side allocation column shows 625.09KB for `fio` and 83.73GB for the base R implementation; keep in mind these figures correspond to R-side allocations only and do not include native allocations inside C++/Rust.
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_m4_d-1.png" alt="\\label{fig:benchmark_d} Superior timing on the R side; reported memory figures are R-side only (see note)."  />
