...
Our benchmarking tests show that `fio` package functions are generally faster than other implementations. This improved performance can make a substantial difference in larger analyses, making the `fio` package a valuable tool for input-output analysis in R.
...
Results shows that {fio} is generally faster than the other two implementations, especially for larger matrices (≥500x500).
...
<img src="figure/benchmark_i5_a-1.png" alt="\label{fig:benchmark_a} For larger matrices (≥500x500), {fio} is generally faster."  />
<p class="caption">\label{fig:benchmark_a} For larger matrices (≥500x500), {fio} is generally faster.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i5_b-1.png" alt="\label{fig:benchmark_b} {fio} is substantially faster."  />
<p class="caption">\label{fig:benchmark_b} {fio} is substantially faster.</p>
</div>
...
Results shows that {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 500x500 and larger.
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i5_c-1.png" alt="\label{fig:benchmark_c} {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 500x500 and larger."  />
<p class="caption">\label{fig:benchmark_c} {fio} is substantially faster than {leontief} across all tested dimensions. Compared to Base R, {fio} is faster for matrices 500x500 and larger.</p>
</div>
...
Results shows that {fio} is almost two times faster than the base R implementation.
...
<div class="figure" style="text-align: center">
<img src="figure/benchmark_i5_d-1.png" alt="\label{fig:benchmark_d} Across all matrix sizes, {fio} demonstrates superior performance, being considerably faster than the Base R implementation."  />
<p class="caption">\label{fig:benchmark_d} Across all matrix sizes, {fio} demonstrates superior performance, being considerably faster than the Base R implementation.</p>
</div>
