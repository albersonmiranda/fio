...
#>       fio   48.1593   50.83130   62.04966   57.1257   62.9013   158.3163   100
#>    Base R 5784.1326 5945.31050 6612.80238 6198.8139 6712.8089 11482.9978   100
#>  leontief   47.6052   50.39215   67.71761   59.9532   72.7854   169.9460   100
...
#> Unit: milliseconds
#>      expr       min        lq      mean    median        uq        max neval
#>       fio  316.5682  343.5537  405.9699  363.1384  431.8462   992.4848   100
#>    Base R 8691.5892 9020.4836 9388.7455 9246.4715 9642.5157 12926.0113   100
#>  leontief 5206.6277 5311.5987 5600.9845 5452.0112 5717.9107  7965.5427   100
...
benchmark_c <- microbenchmark::microbenchmark(
  fio = fio:::compute_sensitivity_dispersion_cv(leontief_inverse_matrix)[1:10],
  `Base R` = sensitivity_r(leontief_inverse_matrix),
  leontief = leontief::sensitivity_dispersion_cv(leontief_inverse_matrix)[1:10],
  times = 100
)
```
...
iom_fio_reduced <- iom$new(
  "iom_reduced",
  intermediate_transactions,
  total_production
)$compute_tech_coeff()$compute_leontief_inverse()
#> Error in eval(expr, envir, enclos): object 'iom' not found
